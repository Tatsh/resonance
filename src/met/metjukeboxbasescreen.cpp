...
MetJukeboxBaseScreen::MetJukeboxBaseScreen(MetRenderer *pRenderer,
    ...
    : MetScreen(pRenderer, nPriority, name, directory, file), mUnknown90(kScrollingListArgument2),
      mUnknown94(kScrollingListArgument3), mUnknown98(nullptr), mUnknown9c(nullptr), mUnknowna0(0),
      mUnknowna4(nullptr), mUnknowna8(nullptr), mUnknownac(nullptr), mUnknownb0(nullptr),
      mUnknownb4(nullptr), mUnknownb8(nullptr), mUnknownbc(0), mUnknownc0(0), mUnknownc4(0),
      mUnknownc8(0), mUnknownd8(nullptr), mUnknowndc(nullptr),
