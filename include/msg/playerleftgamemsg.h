 ...
 *
 * `17PlayerLeftGameMsg` in the RTTI descriptor at `0x00901d40`, with Message as its one base. The
 * object is 0x8 bytes and its vtable is at `0x00811e38`. The members below are the whole of the
