 ...
 *
 * `11GameOverMsg` in the RTTI descriptor at `0x008ef630`, with Message as its one base. The object
 * is 0x4 bytes and its vtable is at `0x007dc508`. The allocation in New() and the allocation in
