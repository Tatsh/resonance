 ...
 * an integer at `+0x08`.
 *
 * The destructor at `0x003daf70` is compiler-generated and has no declaration here.
 */
...
public:
    ...
    /**
     * Report a horizontal powerup-axis movement.
     *
     * Inline, with no address of its own. InputMap::OnControllerReading() at `0x00119bb8` expands
     * it on its stack.
     *
     ...
     */
    AxisXPowMsg(Player *pPlayer, int nValue, Mid::MBT position)
