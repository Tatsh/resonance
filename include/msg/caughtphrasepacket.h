 ...
 * from the copy constructor at `0x003f37b8`, which Clone() delegates to, so the offsets and
 * widths are recovered but the purpose of each field is not. The four words Packet owns are
 * declared there rather than here.
 *
 * The class overrides Message::Print() at `0x003f24a8`. That body streams the payload and is not
