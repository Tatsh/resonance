 ...
 * table. Slots 2, 3, and 4 there hold the pure-virtual handler and slot 5 holds Message::Print(),
 * so the class implements none of the virtuals it inherits and is never instantiated. It is
 * declared because its derived classes need it.
 *
